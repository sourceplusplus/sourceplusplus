 ...
 * }</pre>
 */
public final class RuntimeClassIdentityTypeAdapterFactory<T> implements TypeAdapterFactory {
    private final Class<?> baseType;
    private final String typeFieldName;
    private final Map<String, Class<?>> labelToSubtype = new LinkedHashMap<String, Class<?>>();
    private final Map<Class<?>, String> subtypeToLabel = new LinkedHashMap<Class<?>, String>();

    private RuntimeClassIdentityTypeAdapterFactory(Class<?> baseType, String typeFieldName) {
     ...
     */
    public static <T> RuntimeClassIdentityTypeAdapterFactory<T> of(Class<T> baseType, String typeFieldName) {
        return new RuntimeClassIdentityTypeAdapterFactory<T>(baseType, typeFieldName);
    }
     ...
     * the type field name.
     */
    public static <T> RuntimeClassIdentityTypeAdapterFactory<T> of(Class<T> baseType) {
        return new RuntimeClassIdentityTypeAdapterFactory<T>(baseType, "@identity");
    }
     ...
     */
    public RuntimeClassIdentityTypeAdapterFactory<T> registerSubtype(Class<? extends T> type, String label) {
     ...
     *                                  have already been registered on this type adapter.
     */
    public RuntimeClassIdentityTypeAdapterFactory<T> registerSubtype(Class<? extends T> type) {
...
//    }
        ...
        return new TypeAdapter<R>() {
            ...
            public R read(JsonReader in) throws IOException {
                ...
                if (jsonElement.isJsonObject()) {
                    ...
                    if (delegate == null) {
                        ...
                        delegate = gson.getDelegateAdapter(RuntimeClassIdentityTypeAdapterFactory.this, subClass);
                        if (delegate == null) {
                    ...
                    TypeAdapter<R> delegate = gson.getDelegateAdapter(RuntimeClassIdentityTypeAdapterFactory.this, type);
                    if (delegate == null) {
            ...
            public void write(JsonWriter out, R value) throws IOException {
                ...
                String label = Integer.toHexString(System.identityHashCode(value));
