...
public class LiveBreakpointTransformer extends MethodVisitor {
    ...
    private static final String REMOTE_CLASS_LOCATION = "spp/probe/control/LiveBreakpointRemote";
    ...
    public void visitLineNumber(int line, Label start) {
        ...
        for (LiveBreakpoint bp : LiveBreakpointService.getBreakpoints(new Location(source, line))) {
    ...
    private void processForBreakpoint(String breakpointId, String source, int line) {
        dumpStackTrace(breakpointId, source, line);
    ...
    private void dumpStackTrace(String breakpointId, String source, int line) {
        mv.visitLdcInsn(breakpointId);
